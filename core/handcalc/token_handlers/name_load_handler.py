...
from core.handcalc.token_handlers.token_utils import format_field_name_latex
...
class NameLoadHandler(BaseTokenHandler):
    ...
    def can_handle_core(self, ast_token: ast.AST) -> bool:
        return isinstance(ast_token, ast.Name) and isinstance(ast_token.ctx, ast.Load)
