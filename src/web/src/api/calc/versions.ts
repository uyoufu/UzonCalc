...
import type { CalcReportVersion, ReviewStatus, WorkspaceSnapshot } from './types'
...
export function reviewVersion(reportOid: string, versionName: string, reviewStatus: ReviewStatus, reviewComment?: string | null) { return httpClient.put<CalcReportVersion>(`/calc-report/${reportOid}/versions/${versionName}/review`, { data: { reviewStatus, reviewComment } }) }
