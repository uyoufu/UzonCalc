...
describe('applyFigureLabels', () => {
  ...
  test('按 h2 章节分别重置图表编号', () => {
    ...
    const firstH3 = new FakeElement(
      'h3',
      {},
      { textContent: '第一节', previousElementSibling: firstH2 }
    )
    ...
    const secondH2 = new FakeElement(
      'h2',
      {},
      { textContent: '第二章', previousElementSibling: secondFigure }
    )
